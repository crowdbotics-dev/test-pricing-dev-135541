"""
Django settings for test_pricing_dev_135541 project.
...
ROOT_URLCONF = 'test_pricing_dev_135541.urls'
...
WSGI_APPLICATION = 'test_pricing_dev_135541.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_pricing_dev_135541 API",
    "DESCRIPTION": "API documentation for test_pricing_dev_135541 App",
    "VERSION": "v1",
}
